...
namespace SecondAid.Controllers
{
    ...
    public class MedicationsController : Controller
    {
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var medication = await _context.Medications.SingleOrDefaultAsync(m => m.MedicationId == id);
            if (medication == null)
            {
                return NotFound();
            }
        ...
        public async Task<IActionResult> Create([Bind("MedicationId,Description,Name")] Medication medication)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("MedicationId,Description,Name")] Medication medication)
        {
