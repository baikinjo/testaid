    ...
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> Login(LoginViewModel model, string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    _logger.LogWarning(2, _controllerLocalizer["User account locked out."]);
                    return View("Lockout");
                }
                else
                {
                    ModelState.AddModelError(string.Empty, _controllerLocalizer["Invalid login attempt."]);
                    return View(model);
                }
            }
        ...
        public async Task<IActionResult> Register(RegisterViewModel model, string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                var user = new ApplicationUser {
                    ...
                    Gender = model.Gender,
                    PersonalHealthNumber = model.PersonalHealthNumber,
                ...
                if (result.Succeeded)
                {
                    ...
                    _logger.LogInformation(3, _controllerLocalizer["User created a new account with password."]);
                    return RedirectToLocal(returnUrl);
                }
                AddErrors(result);
            }
        ...
        public async Task<IActionResult> LogOff()
        {
            ...
            _logger.LogInformation(4, _controllerLocalizer["User logged out."]);
        ...
        public async Task<IActionResult> ExternalLoginCallback(string returnUrl = null, string remoteError = null)
        {
            ...
            if (result.Succeeded)
            {
                _logger.LogInformation(5, _controllerLocalizer["User logged in with {Name} provider.", info.LoginProvider]);
                return RedirectToLocal(returnUrl);
            }
            if (result.RequiresTwoFactor)
            {
        ...
        public async Task<IActionResult> ExternalLoginConfirmation(ExternalLoginConfirmationViewModel model, string returnUrl = null)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    {
                        await _signInManager.SignInAsync(user, isPersistent: false);
                        _logger.LogInformation(6, _controllerLocalizer["User created an account using {Name} provider.", info.LoginProvider]);
                        return RedirectToLocal(returnUrl);
                    }
                }
                AddErrors(result);
        ...
        public async Task<IActionResult> SendCode(SendCodeViewModel model)
        {
            ...
            var message = _controllerLocalizer["Your security code is: {0}", code];
        ...
        public async Task<IActionResult> VerifyCode(VerifyCodeViewModel model)
        {
            ...
            if (result.IsLockedOut)
            {
                _logger.LogWarning(7, _controllerLocalizer["User account locked out."]);
                return View("Lockout");
            }
            else
            {
                ModelState.AddModelError(string.Empty, _controllerLocalizer["Invalid code."]);
                return View(model);
            }
        }
